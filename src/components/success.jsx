...
const Success = ({ msg, onClick=() => {} }) => {
  return (
    <div className="w-full p-1 md:p-3 mb-2 flex items-center justify-around bg-green-300 border border-green-100 rounded-lg shadow-sm font-sans">
      ...
      <button
        className="px-2 md:px-3 py-1.5 bg-blue-500 text-sm md:text-base hover:bg-blue-700 text-white rounded-md cursor-pointer"
        onClick={onClick}
        aria-label="Close"
      >
        Login 
