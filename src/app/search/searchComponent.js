...
export default function SearchResults() {
  ...
  const handleDelete = (deletedId) => {
    setResults((prevResults) => prevResults.filter((auction) => auction._id !== deletedId));
  };

  return (
    <main className="w-full h-full flex flex-col items-center justify-center">
      <h1 className="text-2xl font-bold bg-yellow-400 w-[90%] my-5 py-3 rounded text-center">
